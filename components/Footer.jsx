...
export default function Footer() {
  ...
  // Contact page removes the standalone "Get a Quote" section entirely (Final(3) §3.5)
  const hideCTA = isHome || pathname === '/contact';
  return (
    <footer className={`hairline bg-ink text-bone ${isHome ? '' : 'mt-32'}`} style={{ background: '#111111', color: '#F5F5F5' }}>
      <div className="container-edge max-w-[100rem] mx-auto pt-20 pb-10">
        {/* Pre-footer CTA, hidden on the homepage (merged into homepage CTA) and on Contact */}
        {!hideCTA && (
        ...
        <div className="grid md:grid-cols-12 gap-10 pt-16">
          <div className="md:col-span-4 flex flex-col gap-3">
            <span className="relative h-16 w-[15rem] -ml-1">
              <Image
                src="/images/brand/axis-logo-white.png"
        ...
        <div className="mt-8 pt-6 hairline-t flex flex-col items-center text-center gap-2 md:flex-row md:justify-between md:items-center md:text-left eyebrow text-[0.56rem] tracking-[0.05em] md:text-[0.6875rem] md:tracking-[0.22em]" style={{ borderColor: 'rgba(245,245,245,0.14)' }}>
